defmodule GuardianFirebase.KeyManagerTest do
  use ExUnit.Case, async: false
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney

  import GuardianFirebase.KeyManager
  ...
  setup_all do
    Application.put_env(:guardian_firebase, :load_keys_on_startup, true)
    :ok
  end
  ...
  test "server error" do
    use_cassette "firebase_error", custom: true do
      force_reload()
    end
  end
end
